...
#include "ui_createsonglistdialog.h"
#include<QDebug>
CreateSongListDialog::CreateSongListDialog(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CreateSongListDialog)
{
    ui->setupUi(this);
...
//    this->setPalette(pal_windows);
    ...
    connect(createButton, SIGNAL(clicked()), this, SLOT(on_createButtonClicked()));
    connect(cancelButton, SIGNAL(clicked()), this, SLOT(on_cancelButtonClicked()));

}

CreateSongListDialog::~CreateSongListDialog()
{
    delete ui;
}
